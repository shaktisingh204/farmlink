  ...
  return (
    <div className="grid md:grid-cols-2 min-h-screen bg-background">
        ...
        <div className="absolute bottom-8 left-8 text-white">
          <h2 className="text-4xl font-bold font-headline">{t('registerPage_farmer_title')}</h2>
          <p className="text-lg mt-2 max-w-md">{t('registerPage_farmer_description')}</p>
        </div>
      </div>
      <div className="flex flex-col items-center justify-center p-4">
        <div className="w-full max-w-sm">
          <RegistrationForm
            title={t('registrationForm_farmer_title')}
            description={t('registrationForm_farmer_description')}
